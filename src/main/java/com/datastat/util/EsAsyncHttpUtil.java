...
public class EsAsyncHttpUtil {
    ...
    public RequestBuilder getBuilder() {
        ...
        builder.addHeader("Authorization",
                "Basic " + Base64.getEncoder().encodeToString((esUser + ":" + esPassword).getBytes()))
                .setMethod("POST");
        return builder;
    ...
    public ListenableFuture<Response> executeSearch(String esUrl, String index, String query)
    ...
    public ListenableFuture<Response> executeCount(String esUrl, String index, String query)
            throws NoSuchAlgorithmException, KeyManagementException {
        AsyncHttpClient client = getClient();
        RequestBuilder builder = getBuilder();
