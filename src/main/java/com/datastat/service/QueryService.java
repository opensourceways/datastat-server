...
//            redisDao.set(key, result, redisDefaultExpire);
    ...
    public String queryRepoMaintainer(HttpServletRequest request, String community, String repo) {
        ...
        if (result == null) {
            QueryDao queryDao = getQueryDao(request);
            CustomPropertiesConfig queryConf = getQueryConf(request);
            result = queryDao.queryAllRepoMaintainer(queryConf, community, repo);
            redisDao.set(key, result, redisDefaultExpire);
        }
        return result;
    }
    ...
    public String queryRepoSigInfo(HttpServletRequest request, String community, String repo) {
        ...
        if (result == null) {
            QueryDao queryDao = getQueryDao(request);
            CustomPropertiesConfig queryConf = getQueryConf(request);
            result = queryDao.queryRepoSigInfo(queryConf, community, repo);
            redisDao.set(key, result, redisDefaultExpire);
        }
        return result;
    }
    ...
    public String querySoftwareInfo(HttpServletRequest request, String community, String repo, String tag) {
        ...
        if (result == null) {
            QueryDao queryDao = getQueryDao(request);
            CustomPropertiesConfig queryConf = getQueryConf(request);
            result = queryDao.querySoftwareInfo(queryConf, community, repo, tag);
            redisDao.set(key, result, redisDefaultExpire);
        }
        return result;
    }
    ...
    public String putSearchNpsByCommunity(HttpServletRequest request, String token, String community,
